...
def read_entries(frame: pd.DataFrame) -> dict:
    entries = {}
...
output_excel_df.to_excel("output/output.xlsx", index=False)
...
output_csv_df.to_csv("output/pa_output.csv", index=False)
